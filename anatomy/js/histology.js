...
{ question: "What are the processes arising from the cell body of a neuron called?", options: ["dendrites", "neurites", "neuroglia", "axons"], correctAnswer: "neurites", explanation: 'Processes such as dendrites and axons that extend from the cell body are collectively called neurites.' },

{ question: "Which description best characterizes dendrites?", options: ["They extend away from the cell body to transmit impulses", "They are receptive organs that receive signals, with more dendrites allowing greater information processing", "They form the myelin sheath", "They transport proteins synthesized in the cell body"], correctAnswer: "They are receptive organs that receive signals, with more dendrites allowing greater information processing", explanation: 'Dendrites are the primary sites for receiving signals from other neurons—they are receptive, akin to bare branches, and an increased number enhances information processing. (Points 2, 60, 61, 62, 63)' },

{ question: "Which of the following best describes the axon?", options: ["It is the process that extends away from the cell body, transmits impulses outward, branches into collaterals, and contains the trigger zone", "It receives incoming signals from dendrites", "It is primarily responsible for protein synthesis", "It forms bundles called nerve tracts"], correctAnswer: "It is the process that extends away from the cell body, transmits impulses outward, branches into collaterals, and contains the trigger zone", explanation: 'The axon extends away from the cell body, carries impulses outwards, may branch into collaterals, and its initial segment (axon hillock) serves as the trigger zone. (Points 3, 7, 66, 80)' },

{ question: "What is axoplasm and what is it missing compared to the neuronal cell body?", options: ["It is the cytoplasm within the axon that lacks ribosomes", "It is the axonal membrane that lacks mitochondria", "It is the extracellular fluid missing microtubules", "It is the synaptic cleft without any organelles"], correctAnswer: "It is the cytoplasm within the axon that lacks ribosomes", explanation: 'Axoplasm is the cytoplasm inside the axon and contains all the cell organelles except ribosomes. (Points 4, 5)' },

{ question: "How are proteins synthesized in the neuron’s cell body transported to the axon terminals?", options: ["By axoplasmic transport", "By passive diffusion along dendrites", "Via synaptic vesicles", "Through gap junctions"], correctAnswer: "By axoplasmic transport", explanation: 'Proteins made in the cell body are conveyed to the axon terminals via axoplasmic transport. (Point 6)' },

{ question: "Bundles of nerve fibers are termed differently in the CNS and PNS. In the CNS they are called nerve tracts; in the PNS they are known as:", options: ["Peripheral nerves", "Neurite bundles", "Fascicles", "Nerve plexuses"], correctAnswer: "Peripheral nerves", explanation: 'In the central nervous system, bundles are termed nerve tracts, while in the peripheral nervous system they are called peripheral nerves. (Points 8, 9)' },

{ question: "Which of the following accurately describes a synapse?", options: ["It is the junction where the presynaptic axon terminal, synaptic cleft, and postsynaptic cell membrane interact to ensure unidirectional transmission", "It is the region where axons originate", "It is the myelin sheath covering an axon", "It is the gap between two myelinated segments"], correctAnswer: "It is the junction where the presynaptic axon terminal, synaptic cleft, and postsynaptic cell membrane interact to ensure unidirectional transmission", explanation: 'A synapse is formed by the presynaptic terminal, synaptic cleft, and postsynaptic membrane, ensuring unidirectional transmission of chemical signals. (Points 10, 12, 46, 47, 48, 49, 68)' },

{ question: "Outside the CNS, axons typically terminate by:", options: ["Ending at effector organs (muscles or glands) or synapsing with neurons in peripheral ganglia", "Forming nerve tracts", "Becoming dendrites", "Merging with the cell body"], correctAnswer: "Ending at effector organs (muscles or glands) or synapsing with neurons in peripheral ganglia", explanation: 'In the peripheral nervous system, axons either end at an effector organ or form synapses with neurons in a peripheral ganglion. (Point 11)' },

{ question: "Which statement best summarizes the structure, composition, and function of the myelin sheath?", options: ["It insulates axons to increase conduction velocity via saltatory conduction; it is composed of proteins, lipids (cholesterol, phospholipids, glycosphingolipids), and water; produced by oligodendrocytes in the CNS and Schwann cells in the PNS", "It produces action potentials and is composed solely of proteins", "It generates neurotransmitters and is found only in the CNS", "It provides metabolic support and is secreted by astrocytes"], correctAnswer: "It insulates axons to increase conduction velocity via saltatory conduction; it is composed of proteins, lipids (cholesterol, phospholipids, glycosphingolipids), and water; produced by oligodendrocytes in the CNS and Schwann cells in the PNS", explanation: 'The myelin sheath serves as insulation to enhance impulse conduction (saltatory conduction) and is made up of proteins, lipids, and water; oligodendrocytes myelinate CNS axons, whereas Schwann cells myelinate PNS axons. (Points 13, 14, 15, 16, 17, 18, 19, 20, 67, 76, 77)' },

{ question: "Which statement correctly differentiates neuron types based on morphology and location?", options: ["Unipolar neurons (found in dorsal root ganglia for fast reflexes), bipolar neurons (present in vestibular and spiral ganglia), and multipolar neurons (typical of motor neurons)", "Bipolar neurons are the most common in the CNS", "Multipolar neurons are exclusively sensory", "Unipolar neurons are only found in the brain"], correctAnswer: "Unipolar neurons (found in dorsal root ganglia for fast reflexes), bipolar neurons (present in vestibular and spiral ganglia), and multipolar neurons (typical of motor neurons)", explanation: 'Neurons are classified by morphology: unipolar (often in dorsal root ganglia for rapid reflexes), bipolar (in vestibular/spiral ganglia), and multipolar (commonly motor neurons). (Points 21, 22, 23, 24)' },

{ question: "According to Golgi’s classification, which types correspond to neurons with long versus short axons?", options: ["Golgi Type 1 neurons (pyramidal cells with long axons) and Golgi Type 2 neurons (with short axons terminating near the cell body)", "Both types have long axons", "Both types have short axons", "Golgi Type 2 neurons have long axons while Type 1 have short axons"], correctAnswer: "Golgi Type 1 neurons (pyramidal cells with long axons) and Golgi Type 2 neurons (with short axons terminating near the cell body)", explanation: 'Pyramidal cells in the motor cortex are classified as Golgi Type 1 due to their long axons, whereas other cortical neurons with short axons are classified as Golgi Type 2. (Points 27, 28)' },

{ question: "Which option best describes the roles and locations of afferent and efferent nerve fibers?", options: ["Afferent fibers, found in sensory ganglia on dorsal nerve roots, carry signals to the CNS, while efferent fibers, located in grey matter, transmit signals from the CNS to effectors", "Both afferent and efferent fibers carry signals from the CNS to muscles", "Efferent fibers are found only in the PNS", "Afferent fibers transmit signals from the brain to the spinal cord"], correctAnswer: "Afferent fibers, found in sensory ganglia on dorsal nerve roots, carry signals to the CNS, while efferent fibers, located in grey matter, transmit signals from the CNS to effectors", explanation: 'Afferent fibers carry sensory information to the CNS and are located in sensory ganglia (dorsal roots), while efferent fibers send motor commands from the CNS (grey matter) to peripheral targets. (Points 29, 30, 31, 32)' },

{ question: "What are the primary functions of the endoneurium and perineurium in peripheral nerves?", options: ["The endoneurium contains collagen, fibroblasts, Schwann cells, endothelial cells, and macrophages, while the perineurium regulates diffusion of substances in and out of axons", "They both produce myelin", "They generate action potentials", "They are involved in neurotransmitter synthesis"], correctAnswer: "The endoneurium contains collagen, fibroblasts, Schwann cells, endothelial cells, and macrophages, while the perineurium regulates diffusion of substances in and out of axons", explanation: 'The endoneurium provides structural support by surrounding individual nerve fibers, and the perineurium serves as a diffusion barrier. (Points 33, 34)' },

{ question: "Which statement correctly describes neuroglia in the CNS and PNS?", options: ["CNS neuroglia include astrocytes, oligodendrocytes, ependymal cells, and microglia, which are smaller but more numerous than neurons; PNS neuroglia include satellite and Schwann cells", "Neuroglia are only found in the CNS", "Neuroglia are larger than neurons and transmit impulses", "Neuroglia function only to produce myelin"], correctAnswer: "CNS neuroglia include astrocytes, oligodendrocytes, ependymal cells, and microglia, which are smaller but more numerous than neurons; PNS neuroglia include satellite and Schwann cells", explanation: 'Neuroglia are supporting cells: in the CNS they consist of astrocytes, oligodendrocytes, ependymal cells, and microglia, while in the PNS they are primarily satellite and Schwann cells. (Points 35, 36, 37, 38, 39, 40, 41, 52)' },

{ question: "From which embryological origins do various neural cells derive?", options: ["CNS neuroglia (except microglia) originate from the neural tube, microglia from bone marrow, and PNS neurons from the neural crest; glial cells develop from the embryonic neural plate", "All neural cells derive exclusively from the neural crest", "All neural cells originate from mesoderm", "CNS and PNS cells share a common origin from the endoderm"], correctAnswer: "CNS neuroglia (except microglia) originate from the neural tube, microglia from bone marrow, and PNS neurons from the neural crest; glial cells develop from the embryonic neural plate", explanation: 'Different neural cells have distinct embryological origins: most CNS glia arise from the neural tube, microglia from bone marrow, and PNS neurons from the neural crest. (Points 53, 54, 55, 56)' },

{ question: "Which statement best reflects the functional similarity between oligodendrocytes and Schwann cells?", options: ["They both produce myelin and provide electrical insulation for axons", "Only oligodendrocytes produce myelin", "Only Schwann cells are involved in regeneration", "They have completely different functions"], correctAnswer: "They both produce myelin and provide electrical insulation for axons", explanation: 'Both oligodendrocytes in the CNS and Schwann cells in the PNS share the function of myelinating axons and insulating them electrically. (Point 57)' },

{ question: "What roles do ependymal and microglial cells play in the CNS?", options: ["Ependymal cells aid in cerebrospinal fluid movement, while microglia are involved in defense and immune surveillance", "Both are responsible for myelination", "They transmit nerve impulses", "They form the blood-brain barrier"], correctAnswer: "Ependymal cells aid in cerebrospinal fluid movement, while microglia are involved in defense and immune surveillance", explanation: 'Ependymal cells line the ventricles and help circulate CSF, and microglia perform immune functions in the brain. (Points 58, 59, 72)' },

{ question: "The initiation of an action potential in a neuron is best described as:", options: ["A wave of membrane depolarization via voltage-gated Na+ and K+ channels", "A release of neurotransmitters from dendrites", "A passive diffusion of ions", "A mechanical trigger at the synapse"], correctAnswer: "A wave of membrane depolarization via voltage-gated Na+ and K+ channels", explanation: 'Action potentials begin with depolarization of the membrane mediated by voltage-gated sodium and potassium channels. (Points 43, 44)' },

{ question: "What is the approximate resting membrane potential across the axolemma?", options: ["about -65 mV", "about 0 mV", "about +30 mV", "about -100 mV"], correctAnswer: "about -65 mV", explanation: 'The resting potential across the axon membrane is approximately -65 mV, with the inside negative relative to the outside. (Point 45)' },

{ question: "Which statement best describes the soma of a neuron?", options: ["It is the central part containing a dense mesh of microtubules and neurofibrils that form the cytoskeleton", "It is the myelinated segment of the axon", "It is the synaptic junction", "It is solely responsible for neurotransmitter release"], correctAnswer: "It is the central part containing a dense mesh of microtubules and neurofibrils that form the cytoskeleton", explanation: 'The soma (cell body) is the central region of a neuron housing the nucleus and a dense cytoskeletal network. (Points 64, 65)' },

{ question: "Which structural features are true of axons?", options: ["They branch into collaterals and the non-myelinated segments are called nodes of Ranvier", "They do not branch and are completely unmyelinated", "They are solely responsible for receiving signals", "They only exist in the CNS"], correctAnswer: "They branch into collaterals and the non-myelinated segments are called nodes of Ranvier", explanation: 'Axons can form collateral branches and have gaps in myelination known as nodes of Ranvier. (Points 66, 67)' },

{ question: "What functions are performed by astrocytes in the CNS?", options: ["They are the most abundant glial cells, convert blood glucose to lactate for neurons, and form scar tissue after damage", "They transmit electrical impulses", "They produce myelin exclusively", "They serve as the primary receptors for sensory input"], correctAnswer: "They are the most abundant glial cells, convert blood glucose to lactate for neurons, and form scar tissue after damage", explanation: 'Astrocytes support neurons by providing metabolic substrates, such as lactate from glucose, and contribute to scar formation following injury. (Points 69, 70, 71)' },

{ question: "What unique function is attributed to microglial cells?", options: ["They continuously monitor and perform immune checks in the brain", "They generate action potentials", "They form the myelin sheath", "They secrete cerebrospinal fluid"], correctAnswer: "They continuously monitor and perform immune checks in the brain", explanation: 'Microglia are the resident immune cells of the CNS, conducting regular surveillance. (Point 72)' },

{ question: "Which feature is characteristic of ependymal cells?", options: ["They have ciliated cuboidal epithelium and line the ventricular system", "They produce myelin", "They are located in peripheral ganglia", "They form the nodes of Ranvier"], correctAnswer: "They have ciliated cuboidal epithelium and line the ventricular system", explanation: 'Ependymal cells line the brain ventricles and the central canal, featuring cilia to help move cerebrospinal fluid. (Point 73)' },

{ question: "Which statement correctly describes the roles of Schwann and satellite cells in the PNS?", options: ["Schwann cells assist in regeneration of damaged fibers, while satellite cells regulate the chemical environment around neurons", "Both solely form myelin", "Both are found in the CNS", "Satellite cells transmit nerve impulses"], correctAnswer: "Schwann cells assist in regeneration of damaged fibers, while satellite cells regulate the chemical environment around neurons", explanation: 'In the peripheral nervous system, Schwann cells aid regeneration and myelination, whereas satellite cells modulate the neuronal microenvironment. (Points 74, 75)' },

{ question: "What is neurilemma and what structures constitute its external layer?", options: ["It is the outermost covering of the myelin sheath, comprised of basal lamina and endoneurium", "It is the synaptic cleft", "It is the internal axonal cytoplasm", "It is the dendritic spine covering"], correctAnswer: "It is the outermost covering of the myelin sheath, comprised of basal lamina and endoneurium", explanation: 'Neurilemma refers to the thick outer layer of the myelin sheath, formed by the basal lamina and endoneurium. (Points 76, 77)' },

{ question: "How do grey matter and white matter differ in the nervous system?", options: ["Grey matter contains neuron cell bodies and is mostly unmyelinated, whereas white matter is composed of myelinated fibers, glial cells, and blood vessels", "Grey matter consists only of myelinated axons", "White matter contains the neuronal nuclei", "They are identical in structure and function"], correctAnswer: "Grey matter contains neuron cell bodies and is mostly unmyelinated, whereas white matter is composed of myelinated fibers, glial cells, and blood vessels", explanation: 'Grey matter primarily houses neuronal cell bodies and unmyelinated fibers, while white matter is rich in myelinated axons along with supporting glia and vasculature. (Points 78, 79)' },

{ question: "Where is the trigger zone of a neuron located?", options: ["At the axon hillock and initial segment", "In the dendritic spines", "Within the synaptic cleft", "At the cell nucleus"], correctAnswer: "At the axon hillock and initial segment", explanation: 'The trigger zone, where action potentials are initiated, is located at the axon hillock and its adjacent initial segment. (Point 80)' },

{ question: "The axon’s membrane is specifically known as the:", options: ["axolemma", "neurilemma", "dendritic membrane", "synaptic membrane"], correctAnswer: "axolemma", explanation: 'The cell membrane surrounding the axon is termed the axolemma.' },

{ question: "Which of the following is NOT present in the axoplasm?", options: ["Ribosomes", "Mitochondria", "Neurofibrils", "Microtubules"], correctAnswer: "Ribosomes", explanation: 'Axoplasm contains most organelles found in the cell body, except for ribosomes. (Point 5)' },

{ question: "Saltatory conduction is best described as:", options: ["The rapid jumping of nerve impulses between nodes of Ranvier", "The slow diffusion of ions along the axon", "A continuous wave of depolarization along the dendrite", "The passive spread of electrical current across the synapse"], correctAnswer: "The rapid jumping of nerve impulses between nodes of Ranvier", explanation: 'Saltatory conduction refers to the process where action potentials leap from one node of Ranvier to the next, increasing conduction speed. (Points 15, 16)' },

{ question: "Which lipid is NOT considered a main component of myelin?", options: ["Triglycerides", "Cholesterol", "Phospholipids", "Glycosphingolipids"], correctAnswer: "Triglycerides", explanation: 'Myelin primarily contains cholesterol, phospholipids, and glycosphingolipids, not triglycerides. (Point 18)' },

{ question: "The whitish appearance of white matter in the CNS is primarily due to:", options: ["The reflection of light by the myelin sheath", "The high density of neuronal cell bodies", "The abundance of blood vessels", "The presence of astrocytes"], correctAnswer: "The reflection of light by the myelin sheath", explanation: 'Myelin reflects light, contributing to the characteristic white appearance of white matter. (Point 20)' },

{ question: "Unipolar neurons are most commonly found in which location?", options: ["Dorsal root ganglia", "Motor cortex", "Cerebellum", "Olfactory bulb"], correctAnswer: "Dorsal root ganglia", explanation: 'Unipolar neurons are typically located in dorsal root ganglia and are involved in rapid reflex actions. (Point 23)' },

{ question: "Bipolar neurons are characteristically located in:", options: ["Vestibular and spiral ganglia", "The spinal cord", "The cerebral cortex", "Peripheral nerves"], correctAnswer: "Vestibular and spiral ganglia", explanation: 'Bipolar neurons are usually found in the vestibular and spiral ganglia. (Point 22)' },

{ question: "Multipolar neurons are primarily associated with which function?", options: ["Motor functions", "Sensory perception", "Secretion of cerebrospinal fluid", "Immune surveillance"], correctAnswer: "Motor functions", explanation: 'Multipolar neurons, which have multiple processes, are typically involved in motor functions. (Point 24)' },

{ question: "The axon hillock is best described as:", options: ["The initial segment of the axon where the trigger zone is located", "A type of synaptic terminal", "The site of neurotransmitter release", "A region of dendritic input"], correctAnswer: "The initial segment of the axon where the trigger zone is located", explanation: 'The axon hillock is the part of the neuron where action potentials are initiated, serving as the trigger zone. (Points 12, 80)' },

{ question: "Efferent nerve fibers are predominantly found in which region of the nervous system?", options: ["Grey matter of the spinal cord and brainstem", "White matter", "Sensory ganglia", "Dorsal nerve roots"], correctAnswer: "Grey matter of the spinal cord and brainstem", explanation: 'Efferent fibers, which transmit signals from the CNS to effectors, are primarily located in grey matter. (Point 29)' },

{ question: "Afferent nerve fibers are mainly associated with:", options: ["Sensory ganglia", "Motor pathways", "Schwann cells", "Astrocytes"], correctAnswer: "Sensory ganglia", explanation: 'Afferent fibers, which carry sensory information to the CNS, are predominantly found in sensory ganglia. (Point 31)' },

{ question: "The endoneurium is a component of:", options: ["Peripheral nerves", "Central synapses", "Neuron cell bodies", "Glial nuclei"], correctAnswer: "Peripheral nerves", explanation: 'The endoneurium is a connective tissue layer that envelops individual nerve fibers in peripheral nerves. (Point 33)' },

{ question: "The primary function of the perineurium is to:", options: ["Control the diffusion of substances in and out of axons", "Generate electrical impulses", "Produce myelin", "Facilitate synaptic transmission"], correctAnswer: "Control the diffusion of substances in and out of axons", explanation: 'The perineurium acts as a diffusion barrier, regulating the microenvironment of nerve fibers. (Point 34)' },

{ question: "Which glial cell is recognized as the most abundant in the CNS?", options: ["Astrocytes", "Oligodendrocytes", "Microglia", "Ependymal cells"], correctAnswer: "Astrocytes", explanation: 'Astrocytes are the most numerous glial cells in the central nervous system. (Point 69)' },

{ question: "Microglial cells originate from:", options: ["Bone marrow (monocytes)", "The neural tube", "The neural crest", "The embryonic neural plate"], correctAnswer: "Bone marrow (monocytes)", explanation: 'Unlike other neuroglia, microglia are derived from bone marrow monocytes. (Points 55, 72)' },

{ question: "Satellite cells are primarily found in:", options: ["Peripheral ganglia", "The CNS", "White matter tracts", "Cerebral cortex"], correctAnswer: "Peripheral ganglia", explanation: 'Satellite cells envelop neurons in peripheral ganglia and help regulate their chemical environment. (Points 40, 56, 75)' },

{ question: "Oligodendrocytes in the CNS and Schwann cells in the PNS share which key function?", options: ["Myelin production and electrical insulation", "Neurotransmitter synthesis", "Action potential generation", "CSF production"], correctAnswer: "Myelin production and electrical insulation", explanation: 'Both oligodendrocytes and Schwann cells are responsible for producing myelin and insulating axons. (Point 57)' },

{ question: "Ependymal cells are involved in which of the following functions?", options: ["Facilitating the movement of cerebrospinal fluid", "Producing myelin", "Transmitting nerve impulses", "Generating action potentials"], correctAnswer: "Facilitating the movement of cerebrospinal fluid", explanation: 'Ependymal cells line the ventricular system and aid in the circulation of cerebrospinal fluid. (Points 58, 73)' },

{ question: "Which channels in the axolemma are responsible for initiating the action potential?", options: ["Voltage-gated Na+ and K+ channels", "Ligand-gated Cl– channels", "Calcium channels", "Mechanosensitive channels"], correctAnswer: "Voltage-gated Na+ and K+ channels", explanation: 'The action potential is initiated by the opening of voltage-gated sodium and potassium channels in the axolemma. (Point 44)' },

{ question: "What is the typical resting membrane potential of a neuron?", options: ["about -65 mV", "about +30 mV", "about 0 mV", "about -90 mV"], correctAnswer: "about -65 mV", explanation: 'Neurons have a resting membrane potential of approximately -65 mV, with the interior being negative relative to the exterior. (Point 45)' },

{ question: "Which of the following best defines the structure of a synapse?", options: ["It comprises the presynaptic axon terminal, synaptic cleft, and postsynaptic cell membrane", "It is a continuous cytoplasmic bridge", "It is solely an electrical junction", "It is the area where dendrites merge"], correctAnswer: "It comprises the presynaptic axon terminal, synaptic cleft, and postsynaptic cell membrane", explanation: 'A synapse is a specialized junction consisting of the presynaptic terminal, a synaptic cleft, and the postsynaptic membrane, ensuring directional signal flow. (Points 10, 48, 49)' },

{ question: "The trigger zone, where action potentials are initiated, is located at:", options: ["The axon hillock and initial segment", "Dendritic spines", "The synaptic cleft", "The cell nucleus"], correctAnswer: "The axon hillock and initial segment", explanation: 'The trigger zone is found at the axon hillock and its adjacent initial segment, where action potentials are generated. (Point 80)' },
